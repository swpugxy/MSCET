...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='mscet', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('MSCET training and evaluation script', parents=[get_args_parser()])
